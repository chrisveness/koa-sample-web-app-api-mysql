...
// cache reverse-dns lookups for domain-name & country - could be saved in db, but in-app will do for now
...
class Ip {
    ...
    static async getDomain(ip) {
        ...
        if (ip=='127.0.0.1' || ip=='::ffff:127.0.0.1') { domainCache.set(ip, null); return null; }
